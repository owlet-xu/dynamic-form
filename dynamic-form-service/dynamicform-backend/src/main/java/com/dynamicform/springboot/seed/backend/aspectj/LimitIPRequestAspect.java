...
import com.dynamicform.springboot.seed.common.qiqi.HttpRestException;
import com.dynamicform.springboot.seed.common.qiqi.LimitIPRequestAnnotation;
...
public class LimitIPRequestAspect {
     ...
     */
    @Before("execution(*  com.dynamicform.com.springboot.seed.bz1.controller.*.*(..)) && @annotation(com.dynamicform.springboot.seed.common.qiqi.LimitIPRequestAnnotation)")
