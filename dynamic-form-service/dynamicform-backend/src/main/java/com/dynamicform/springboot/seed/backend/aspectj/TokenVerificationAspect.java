package  com.dynamicform.springboot.seed.backend.aspectj;

import com.alibaba.fastjson.JSONObject;
import  com.dynamicform.springboot.seed.common.configs.XseedSettings;
import  com.dynamicform.springboot.seed.common.exception.BusinessException;
import  com.dynamicform.springboot.seed.common.exception.ResultStatus;
import  com.dynamicform.springboot.seed.common.redis.RedisUtil;
import  com.dynamicform.springboot.seed.common.util.HttpServletContextHolder;
...
public class TokenVerificationAspect {
    ...
    @Pointcut("execution(public *  dynamicform.dynamicform.springboot.seed.bz1.controller..*.*(..))")
